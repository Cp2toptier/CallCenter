<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EquipmentTypeListU.aspx.cs" Inherits="Callcenter.User.EquipmentTypeListU" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
            $.ajax({
                type: "POST",
                url: "EquipmentTypeListU.aspx/GetEquipmentTypes",
                data: "{}",
                            ...
                            { "bVisible": false, "aTargets": [0] },
                                {
                                    ...
                                    "mRender": function (data, type, full) {
                                        return '<a href="EquipmentTypeNewEditU.aspx?Id=' + data + '">Editar</a>';
                                    }
                                },
                                {
                                    "bSortable": false,
                                    ...
                                    "mData": 0,
                                    "mRender": function (data, type, full) {
                                        return '<a href="EquipmentTypeListU.aspx?Id=' + data + '">Eliminar</a>';
                                    }
                                }
