<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EquipmentList.aspx.cs" Inherits="Callcenter.Admin.EquipmentList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
            $.ajax({
                type: "POST",
                url: "EquipmentList.aspx/GetEquipments",
                data: "{}",
                            ...
                            { "bVisible": false, "aTargets": [0] },
                                {
                                    ...
                                    "mRender": function (data, type, full) {
                                        return '<a href="EquipmentNewEdit.aspx?Id=' + data + '">Editar</a>';
                                    }
                                },
                                {
                                    "bSortable": false,
                                    ...
                                    "mData": 0,
                                    "mRender": function (data, type, full) {
                                        return '<a href="EquipmentList.aspx?Id=' + data + '">Eliminar</a>';
                                    }
                                }
