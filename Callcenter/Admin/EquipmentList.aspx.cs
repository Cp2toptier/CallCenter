    ...
    public partial class EquipmentList : System.Web.UI.Page
    {
        ...
        public static JsonDataTable GetEquipments()
        {
            try
            {
                ...
                IQueryable<Equipment> list = eManager.GetAll();
        ...
        public static JsonDataTable EquipmentJsDataTable(IEnumerable<Equipment> list)
        {
            ...
            { //Hay primer elemento
                ...
                { //Crea una fila por cada elemento de la lista
                    ...
                    vl.Add(equipment.Id);
                    MembershipUser user = Membership.GetUser(equipment.UserId);
                    vl.Add(user.UserName);
                    vl.Add(equipment.Description);
                    vl.Add(equipment.EquipmentType.Type);
                    vl.Add(equipment.PurchaseDate.ToString());
                    jsDT.add_Row(vl);
                }
            }
            return jsDT;
        ...
        {
            Response.Redirect("EquipmentNewEdit.aspx");
        }
    }
}